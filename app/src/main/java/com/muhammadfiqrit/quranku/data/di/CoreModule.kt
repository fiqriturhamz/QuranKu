package com.muhammadfiqrit.quranku.data.di
...
import com.muhammadfiqrit.quranku.utils.Utilities.BASE_URL
...
val repositoryModule = module {
    ...
    single<ISuratRepository> { SuratRepository(get(), get(), get()) }
