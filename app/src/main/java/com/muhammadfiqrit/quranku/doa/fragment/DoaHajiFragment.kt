...
import com.muhammadfiqrit.quranku.databinding.FragmentDoaHajiBinding
...
class DoaHajiFragment : Fragment() {

    private var _binding: FragmentDoaHajiBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDoaHajiBinding.inflate(inflater, container, false)
        return binding.root
    }
